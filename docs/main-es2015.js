...
let DetailsComponent = class DetailsComponent {
    constructor(detailService, serviceLogin) {
...
let LoginService = class LoginService {
    ...
    AddUser(detail) {
        return this.http.post("http://localhost:18553/api/user", detail).subscribe((res) => {
            if (!res.IsSuccessful) {
